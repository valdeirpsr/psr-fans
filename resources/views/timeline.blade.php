...
<header class="container sm:max-w-5xl">
    ...
    <div class="card pt-0">
        <div class="flex items-center space-x-4 -mt-6">
            <img src="https://placehold.co/96" class="rounded-full border-[2px] border-white" alt="Perfil" height="96" width="96" />
    ...
    <div class="card" x-data={}>
        <p class="text-sm text-gray-500">Assine</p>

        <div class="mt-3 text-center">
            <x-inputs.button type="button" @click="$dispatch('open-subscribe-modal')">
    ...
    {{-- <div class="card" x-data={}>
        <p class="text-sm text-gray-500">Sua assinatura expira em 31 dez 2023</p>
